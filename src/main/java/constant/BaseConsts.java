...
public class BaseConsts {
    ...
    public static final String ACCESS_KEY = "BOhCLzhdO2wBTy_xcB8C2XWuY-tiLoi16B0X4ZYr";
    public static final String SECRET_KEY = "WKYjEU9aLCLNHhJNsknC44v4qHVbbbNIVrv_qaO5";
    public static final String BUCKET = "dlimagecoder";

    public static final String BASE_IMG_URL = "http://pcqi1922c.bkt.clouddn.com/";
